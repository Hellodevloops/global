								...
								<div class="sbox-3 icon-lg">
									<a>
										...
										@php
											...
											$formattedTimings = collect($batchTimings)->map(function ($item) {
                                   ...
                                   <p>Batch Timing(s): {{ $formattedTimings }}</p>
										...
										<!-- Enquiry Button -->
										<button type="button" class="btn btn-primary mt-20 text-uppercase" data-type="general" data-toggle="modal" data-target="#enquiryModal" >Enquire</button>

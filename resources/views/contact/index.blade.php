...
@section('meta_description', 'Achieve IELTS Excellence! Nashiks Top Consultancy Awaits. Tailored Strategies for Your
    Academic Triumph! Contact Us.')
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 section-title center">
                    ...
                    <!-- Text -->
                    <p class="p-md">If you have any questions or need further assistance,<br> please feel free to reach out
                        to us. We are here to help!</p>
                    ...
                    <div class="contact-boxes">
                        ...
                        <div class="contact-box icon-xs clearfix mb-25">
                            ...
                            <div class="contact-box-txt">
                                <h5 class="h5-sm deepblue-color">2nd floor, Godagaurav Apartment, Shivgiri Colony, Next to
                                    Domino’s, College road, Nashik-422005</h5>
                        ...
                        <div class="contact-box icon-xs clearfix">
                            ...
                            <div class="contact-box-txt">
                                <h5 class="h5-xs deepblue-color"><a
                                        href="mailto:mailinfo.gec@gmail.com">mailinfo.gec@gmail.com</a></h5>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" name="name" value=""
                                            id="firstName" required="" placeholder="First name" aria-label="First name">
                                    </div>
                                    @error('name')
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="tel" name="phone" class="form-control" value=""
                                            required="" placeholder="Phone" aria-label="Phone" fdprocessedid="d66hwh">
                                    </div>
                                    @error('phone')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="email" name="email" class="form-control" value=""
                                            required="" placeholder="Email" aria-label="Email" fdprocessedid="xrlb5v">
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="g-recaptcha" data-sitekey="6Lc4lb0pAAAAAFFyOJgBpj9Tiz5nyYPaccXijKpo"></div>

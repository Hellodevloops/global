                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="sbox-7 sbox-color">
                                    ...
                                    <div class="sbox-7-txt {{ $bgClass }} white-color">
                                        ...
                                        <!--Link -->
                                        <a href="{{ route('courses.show', ['course' => $course]) }}" class="btn btn-sm btn-tra-white primary-hover">Read More</a>
							...
							<div class="col-md-6 col-lg-4">
								<div class="sbox-7 sbox-color">
									...
									<div class="sbox-7-txt bg-2 white-color">	
										...
										<!-- Title -->
										<h5 class="h5-xl">French Language Trainings</h5>
										...
										<!--Link -->
										<a href="course-details.html" class="btn btn-sm btn-tra-white primary-hover">Read More</a>
							...
							<div class="col-md-6 col-lg-4">
								<div class="sbox-7">
									...
									<div class="sbox-7-txt bg-3 white-color">	
										...
										<!-- Title -->
										<h5 class="h5-xl">English Language Trainings</h5>
							...
							<div class="col-md-6 col-lg-4">
								<div class="sbox-7">
									...
									<div class="sbox-7-txt bg-4 white-color">	
										...
										<!-- Title -->
										<h5 class="h5-xl">Foreign Language Training</h5>
							...
							<div class="col-md-6 col-lg-4">
								<div class="sbox-7">
									...
									<div class="sbox-7-txt bg-5 white-color">	
										...
										<!-- Title -->
										<h5 class="h5-xl">Visa Process Assistance</h5>
							...
							<div class="col-md-6 col-lg-4">
								<div class="sbox-7">
									...
									<div class="sbox-7-txt bg-6 white-color">
										...
										<!-- Title -->
										<h5 class="h5-xl">Pre Departure Briefing</h5>
							...
							<div class="col-md-6 col-lg-4">
								<div class="sbox-7">
									...
									<div class="sbox-7-txt bg-7 white-color">
										...
										<!-- Title -->
										<h5 class="h5-xl">GRE - Graduate Record Exam</h5>
							...
							<div class="col-md-6 col-lg-4">
								<div class="sbox-7">
									...
									<div class="sbox-7-txt bg-8 white-color">
										...
										<!-- Title -->
										<h5 class="h5-xl">PTE - Pearson Test of English (PTE)</h5>

...
<section class="feature-section-two ptb-120">
    <div class="container">
        <div class="section-heading text-center mb-5">
            ...
            <p class="lead mt-3"> Our firm stands out for its reputable status, international exposure, skill development opportunities, potential for long-term career growth, strong industry network, and comprehensive immigration support.</p>
        </div>
        <div class="row align-items-center justify-content-lg-between justify-content-center">
                ...
                <ul class="list-unstyled mb-0">
                    <li class="d-flex align-items-start mb-4">
                        ...
                        <div class="icon-content">
                            ...
                            <p> The prospect of interning at a firm that offers migration opportunities to countries like the USA and Canada.
                            </p>
                        </div>
                    </li>
                    <li class="d-flex align-items-start mb-4">
